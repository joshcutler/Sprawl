...
public enum BlockType {
	STONE("/textures/stone.png", true, 0.3f, true, 30, ItemType.STONE_BLOCK), 
	AIR("/textures/air.png", false, 1f, false, 0, ItemType.AIR_BLOCK), 
	DIRT("/textures/dirt.png", true, 0.3f, true, 10, ItemType.DIRT_BLOCK);
